...
export const CompletedFundedProject = ({
  completedFundedProjectDetails = [],
}) => {
  if (completedFundedProjectDetails.length === 0) return <></>;

  return (
    <section
      id="completed-funded-project"
      className="h-screen p-2 md:p-10 flex flex-col justify-center gap-5"
    >
      <Heading>Completed Funded Project</Heading>
      ...
      <div className="!grid">
        <TableContainer>
          <Table variant={"striped"}>
            ...
            <Tbody>
              {completedFundedProjectDetails.map(
